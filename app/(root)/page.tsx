    ...
    <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 md:grid-cols-2 xl:gap-10">
      ...
      <section className="h-full rounded-[20px] bg-white p-5 xl:p-8">
        ...
        {files.documents.length > 0 ? (
              ...
              >
                ...
                <div className="flex w-full flex-col xl:flex-row xl:justify-between">
                  <div className="flex flex-col gap-1">
                    <p className="text-[14px] leading-[20px] font-semibold line-clamp-1 w-full text-light-100 sm:max-w-[200px] lg:max-w-[250px]">{file.name}</p>
                    <FormattedDateTime
                      date={file.$createdAt}
          ...
          <p className="text-[16px] leading-[24px] font-normal mt-10 text-center text-light-200">No files uploaded</p>
        )}
      </section>
    </div>
  );
